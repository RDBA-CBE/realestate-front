...
import { Bed, Bath, Square, MapPin, Heart, Copy, Share, GitCompareIcon, GitCompareArrowsIcon } from 'lucide-react';
    ...
    >
      ...
      <div className={`relative ${view === 'list' ? 'w-2/5' : ''}`}>
        {property?.primary_image && (
         ...
         {!hover && (
            <Badge className="absolute top-5 left-5 bg-red-500 text-white font-semibold capitalize border-none rounded-full px-4 py-1.5">
        ...
        <div>
          ...
          <h3
            className={` text-gray-900 pb-1 ${
              view === 'list' ? 'text-2xl mb-1' : 'text-2xl mb-2'
            }`}
          >
            {property.title}
          </h3>
