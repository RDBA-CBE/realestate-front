        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            <div className="flex items-start space-x-3">
              <Checkbox id="contact" className="mt-0.5 border-gray-400 data-[state=checked]:bg-red-600" />
            ...
            <div className="flex items-start space-x-3">
              <Checkbox id="loans" className="mt-0.5 border-gray-400 data-[state=checked]:bg-red-600" />
