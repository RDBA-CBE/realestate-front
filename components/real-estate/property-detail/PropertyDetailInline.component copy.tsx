...
export default function PropertyDetailInline(props: PropertyDetailInlineProps) {
  ...
  const handleRedirect = () => {
    router.push(`/property-list/${getPropertyPathValue(state.detail)}`);
  };
          ...
          >
            ...
            <div className="flex items-center gap-2">
              <Button
                ...
                size="icon"
                variant="outline"
                className={`rounded-full ${state.detail?.user_wishlists
              ...
              <Button
                ...
                size="icon"
                variant="outline"
                className={`rounded-full ${state?.is_compare
                    ...
                    <div className="flex space-x-2 overflow-x-auto max-w-full pb-2">
                      {state.detail.images?.map((img, index) => (
                        <button
                          ...
                          className={`flex-shrink-0 w-16 h-16 rounded-lg overflow-hidden border-2 ${state.currentImageIndex === index
                              ? "border-blue-500"
                              : "border-transparent"
                            }`}
                        >
