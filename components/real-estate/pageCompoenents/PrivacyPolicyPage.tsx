          ...
          <div className="space-y-10">
            ...
            <div className="border-b border-gray-100 pb-8 last:border-0">
              ...
              {[
                ...
                ["D. For Platform and Service improvement:", "We may use Personal Data to improve our Platform and its content, to ideate, develop and provide new or better Platform features or Services. For this purpose, we may use data collected through the information you provide us through your feedbacks, through our marketing research and surveys or through the use of the Platform. We may also use Personal Data for providing a better user experience on the Platform and to personalize the Platform for improving your usability of the Platform. The Platform uses YouTube API services. In order to check the performance of a video we may track the video play, pause, mute/unmute action performed by the user on the Platform."],
                ["E. For fraud prevention:", "We may use Personal Data for identifying suspicious users or property listings on the Platform, for verifying users and property listing on Platform, for ensuring network security; and to prevent, detect, investigate and prosecute crimes (including but not limited to fraud and other financial crimes) on the Platform. We may also undertake other due diligence checks on suspicious users or property listings, including government sanctions screening and we may seek additional information from you, for such purpose."],
                ["F. For troubleshooting and recovery:", "We may use your Personal Data to troubleshoot issues or problems with the Platform or Services and for maintain adequate backs-ups to ensure high availability, and aid in disaster recovery."],
            ...
            <div className="border-b border-gray-100 pb-8 last:border-0">
              ...
              <p className="leading-relaxed mb-3">
                Some of our web pages utilize <strong> &quot;Cookies&quot; </strong> and other tracking technologies. A Cookie is a small text file that may be used, for example, to collect information about web-site activity. Some cookies and other technologies may serve to recall Personal Data previously indicated by a user.
              </p>
              <p className="leading-relaxed mb-3">
            ...
            <div className="border-b border-gray-100 pb-8 last:border-0">
              ...
              <ul className="space-y-3">
                <li className="flex gap-3 leading-relaxed">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-dred flex-shrink-0" />
                  <span>If you wish to access, verify, correct, complete, update or erase any of your Personal Data collected through the Platforms or Services, you may write to us at <strong>(email_id).</strong></span>
                </li>
                <li className="flex gap-3 leading-relaxed">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-dred flex-shrink-0" />
                  <span>You may withdraw your consent for any or all processing of your Personal Data by sending a mail to <strong>(email)</strong>. Do note however, that the Company reserves the right to refuse to provide you access to the Platform and Services in circumstances where such Personal Data is essential to the provision of the Platform and Services.</span>
                </li>
                <li className="flex gap-3 leading-relaxed">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-dred flex-shrink-0" />
                  <span>•	We (or our service providers or partners) may communicate with you through voice calls, text messages, emails, Platform notifications, or other means. The communication may relate to (a) your purchases, payments, or other messages related to your use of the Platform, or (b) offers or promotions about our Platform, new features or Services. You may opt out of receiving information about promotional offers by writing to our grievance officer. We may still need to send you non-promotional communication (information about the Platforms and Services).</span>
                </li>
              </ul>
              <p className="leading-relaxed mt-4">
                Please note that the Platform sometimes displays advertisements or contains links to third party websites that may collect personal data, and those are not governed by this Policy. The Company will not be responsible for the privacy practices of such websites. The Company recommends that you review the privacy policy of each third-party site linked from the Platform to determine their use of your Personal Data.
