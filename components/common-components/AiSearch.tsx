                              ...
                              >
                                {prop.primary_image && (
                                  <img
                                    ...
                                    alt={prop.title}
                                    onClick={() =>
                                      router.push(`/property-list/${getPropertyPathValue(prop)}`)
                                    }
                ...
                <div className="flex flex-col gap-3">
                  <div className="flex flex-col gap-1">
                    ...
                    <input
                      ...
                      className={`w-full bg-background border rounded-xl px-3 py-2 text-sm outline-none transition-colors ${bookingErrors.date
                        ? "border-red-500"
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <input
                      ...
                      className={`w-full bg-background border rounded-xl px-3 py-2 text-sm outline-none transition-colors placeholder:text-muted-foreground ${bookingErrors.email
                        ? "border-red-500"
                        : "border-border focus:border-themeColor1"
                        }`}
                    />
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <input
                      ...
                      className={`w-full bg-background border rounded-xl px-3 py-2 text-sm outline-none transition-colors placeholder:text-muted-foreground ${bookingErrors.phone
                        ? "border-red-500"
                        : "border-border focus:border-themeColor1"
                        }`}
                    />
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <textarea
                      ...
                      rows={3}
                      className={`w-full bg-background border  rounded-xl px-3 py-2 text-sm outline-none  transition-colors placeholder:text-muted-foreground resize-none  ${bookingErrors.message
                        ? "border-red-500"
                        : "border-border focus:border-themeColor1"
                        }`}
                    />
                ...
                <div className="flex flex-col gap-3">
                  <div className="flex flex-col gap-1">
                    ...
                    <input
                      ...
                      placeholder="Phone number (10 digits)"
                      className={`w-full bg-background border rounded-xl px-3 py-2 text-sm outline-none transition-colors placeholder:text-muted-foreground ${callbackErrors.phone
                        ? "border-red-500"
                        : "border-border focus:border-themeColor1"
                        }`}
                      required
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <textarea
                      ...
                      placeholder="Tell us more about your inquiry..."
                      rows={3}
                      className={`w-full bg-background border  rounded-xl px-3 py-2 text-sm outline-none transition-colors placeholder:text-muted-foreground resize-none ${callbackErrors.message
                        ? "border-red-500"
                        : "border-border focus:border-themeColor1"
                        }`}
                      required
