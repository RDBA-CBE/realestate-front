...
const PrivacyTabStyle = ({ sections }) => {
    ...
    <div className="grid lg:grid-cols-3 gap-12 items-start">
      ...
      <div className="lg:col-span-1">
        <div className="bg-[#f8f8f8] rounded-2xl p-8 sticky top-28">
          ...
          <h2 className="section-in-ti mb-3">Our Commitment to Your Privacy</h2>
          <p className=" text-sm leading-relaxed mb-6">
            This policy describes how Real Estate collects, uses, and shares
          ...
          >
            ...
            {openIndex === i && (
              <div className="px-7 pb-6">
                ...
                <p className=" leading-relaxed text-[15px] mb-4">{s.content}</p>
                {s.list && (
...
export default PrivacyTabStyle;
